...
const MessageList = ({
  ...
  const handleDeleteForEveryone = async (messageId: string) => {
    const confirmed = window.confirm("Delete message for everyone?");
  ...
  const handleDeleteForMe = async (messageId: string) => {
    const confirmed = window.confirm("Delete message for you only?");
  ...
  return (
    ...
    >
      ...
      {!activeConversationId || isMessagesFetching ? (
        ...
        <EmptyMessage name={selectedGuard?.name ?? "User"} />
      ) : (
