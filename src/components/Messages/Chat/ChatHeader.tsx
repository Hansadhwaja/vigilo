import { MoreVertical, Phone, ShieldCheck, Video } from "lucide-react";
...
const ChatHeader = ({
  ...
  const isOnline = selectedPresence?.isOnline;
            ...
            <div
              className={cn(
                `
                                ...
                                transition-all
                                `,
                isOnline && "shadow-emerald-100",
              )}
            >
              <UserAvatar src="" name={selectedGuard?.name} />
            </div>
