...
const ViewClientModal = ({ client }: { client: Client }) => {
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-2xl overflow-y-auto max-h-[90vh] rounded-3xl border-0 p-0 no-scrollbar">
        {/* TOP SECTION */}
        <div className="relative overflow-hidden bg-gradient-to-r from-orange-500 via-orange-400 to-sky-500 px-8 py-10 text-white">
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            >
              <img
                src={client.avatar || "https://ui-avatars.com/api/?name=Client"}
                alt={client.name}
        ...
        <div className="space-y-5 p-8">
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="font-mono text-sm text-slate-700">#{client.id}</p>
            </div>
          </div>
        </div>
      </DialogContent>
