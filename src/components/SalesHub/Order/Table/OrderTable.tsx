      ...
      render: (row) => (
        <div className="flex max-w-60 items-start gap-3">
          ...
          <div className="space-y-1">
            <p className="font-semibold uppercase truncate w-40">
              {row.locationName}
            </p>
      ...
      render: (row) => (
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="space-y-0.5 text-left">
            <p className="font-semibold text-slate-800">{row.guardsRequired}</p>

            <p className="text-sm text-slate-500">Guards</p>
          </div>
        </div>
      ),
    },
