...
import { Eye, Edit, Clock3 } from "lucide-react";
            ...
            <AccordionTrigger className="hover:no-underline p-2 flex justify-center items-center">
              <div className="flex items-center justify-between w-full gap-4">
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <UserAvatar src="" name={payment.guard.name} />
                ...
                <div className="hidden md:flex items-center gap-3">
                  ...
                  <div className="px-3 py-1.5 rounded-lg bg-orange-50 border border-orange-100">
                    <p className="text-[11px] text-orange-600">Overtime</p>
            ...
            <AccordionContent className="pt-4 space-y-4">
              ...
              <div className="rounded-lg border bg-slate-50 p-3 text-sm space-y-1">
                ...
                <div className="flex justify-between text-red-500">
                  <span>Other</span>
                  <span>
                    -{formatCurrency(Number(payment.otherDeductions))}
                  </span>
                </div>
              </div>
