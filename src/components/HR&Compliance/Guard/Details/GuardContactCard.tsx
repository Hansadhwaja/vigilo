...
const GuardContactCard = ({ guard }: { guard: Guard }) => {
  return (
    <SectionCard
      ...
      <div className="space-y-6">
        ...
        <div
          className="
                ...
                "
        >
          <p className="text-sm text-slate-500">Guard Communication Details</p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <Button size="sm" variant="outline" asChild>
              <Link to={`tel:${guard.mobile}`}>Call</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <Button size="sm" variant="outline" asChild>
              <Link to={`mailto:${guard.email}`}>Email</Link>
            </Button>
          </div>
        </div>
