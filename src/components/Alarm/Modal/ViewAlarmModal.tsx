            ...
            <div className="bg-gray-50 p-4 rounded-lg border">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <CustomBadge status={alarm.priority} />
                </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium capitalize mr-60">{"N/A"}</span>
              </div>

              <div className="flex justify-between">
                <span className="text-gray-500">Assigned Guard -</span>
                <span className="mr-45">{alarm.assigned || "Unassigned"}</span>
              </div>

              <div className="flex justify-between">
                <span className="text-gray-500">ETA -</span>
                <span className="mr-65">{alarm.eta || "Not calculated"}</span>
              </div>
              ...
              {alarm.completedAt && (
                <div className="flex justify-between">
                  ...
                  <span>{new Date(alarm.completedAt).toLocaleString()}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-red-50 p-4 rounded-lg border border-red-200">
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span
                  className={getSLAColor(alarm.sinceMins, alarm.slaTargetMins)}
                >
              ...
              {alarm.slaTargetMins > 0 && (
                <Progress
                  value={Math.min(
                    (alarm.sinceMins / alarm.slaTargetMins) * 100,
                    100,
                  )}
                  className="h-3"
                />
              ...
              {alarm.slaTargetMins > 0 &&
                alarm.sinceMins > alarm.slaTargetMins && (
                  <div className="text-red-600 font-medium text-sm">
                    ⚠️ SLA Breach: {alarm.sinceMins - alarm.slaTargetMins}{" "}
                    minutes overdue
                  </div>
                )}
            </div>
