...
const GuardActivityCard = ({ shift }: { shift: Activity }) => {
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          <p className="text-sm uppercase tracking-wide text-slate-400">Date</p>
          ...
          <div className="rounded-xl border border-slate-200 p-4">
            ...
            <p className="font-semibold text-slate-800">
              {shift.timesheet?.clockInTime
                ? formatTime(shift.timesheet?.clockInTime)
                : "—"}
            </p>
          </div>

          <div className="rounded-xl border border-slate-200 p-4">
            <p className="text-sm text-slate-400">Clock Out</p>

            <p className="font-semibold text-slate-800">
              {shift.timesheet?.clockOutTime
                ? formatTime(shift.timesheet?.clockOutTime)
                : "—"}
            </p>
          </div>
        </div>
